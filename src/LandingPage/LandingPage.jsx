    ...
    <>
      ...
      <div className=" feedContainer  w-full m-0 p-0 overflow-hidden relative z-10">
        ...
        <footer className="bg-gray-900 text-gray-200 font-serif">
          ...
          <div className="container mx-auto py-6 px-6 ">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-14 ">
              ...
              <div className="p-2">
                ...
                <div className="my-5">
                  <a className="text-lg font-medium my-1" href="/">
                  ...
                  <br />
                  <a className="text-lg font-medium" href="/">
                    Fortune To Get There
                  </a>
                  <hr className="my-5 w-1/2" />
                  <a className="font-mono text-base font-medium" href="">
              ...
              <div className="p-2">
                ...
                <div className="flex items-center p-2 gap-1 bg-gray-500 rounded-3xl overflow-hidden  w-72 lg:w-60 h-14">
                  ...
                  />
                  <button className="bg-slate-300 hover:bg-yellow-200 text-black outline-none  w-40 h-14 relative rounded-3xl left-7">
                    Subscribe
                  </button>
                </div>
                ...
                <div className="mt-5 flex space-x-4 items-center">
                  <a
                    href=""
                    className=" transition ease-linear duration-100 hover:scale-125 "
                  >
              ...
              <div className="p-2">
                ...
                <p className="text-lg">
                  ...
                  qui sit ratione necessitatibus molestiae sint? Quos id,
                  mollitia ratione voluptatibus <em>example text</em>.
                </p>
                <br />
                <p className="text-lg">
          ...
          <h4 className="py-4 text-center text-lg ">
            Cpoyright ! Made by Biswajit | Commando @2024 ! All rigts Reserved
            🖕
          </h4>
        </footer>
        {/* end */}
